 ...
 */
$router->GET('/countries', 'CountriesAndCitiesApi@countriesGet');
/**
 * GET countriesIdGet
 ...
 * Output-Formats: [application/json]
 */
$router->GET('/countries/{id}', 'CountriesAndCitiesApi@countriesIdGet');
/**
 * GET statesIdGet
 ...
 * Output-Formats: [application/json]
 */
$router->GET('/states/{id}', 'CountriesAndCitiesApi@statesIdGet');
/**
 * POST firstStepPost
